      ...
      <svg viewBox="0 10 211.73 180" strokeLinecap="round" strokeLinejoin="round">
        <defs>
          ...
          <linearGradient id="linear-gradient" x1="102.94" y1="154.47" x2="102.94" y2="36.93" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#191617" />
            <stop offset="0.01" stopColor="#281b20" />
            <stop offset="0.19" stopColor="#191617" />
            <stop offset="0.35" stopColor="#281b20" />
            <stop offset="0.47" stopColor="#281b20" />
            <stop offset="0.54" stopColor="#191617" />
            <stop offset="0.6" stopColor="#191617" />
            <stop offset="1" stopColor="#191617" />
          </linearGradient>
        </defs>
        ...
        <g clipPath="url(#background-clip)">
          <g className="me" style={{ opacity: 1 }}>
            <g className="body">
              ...
              />
              <path className="neck" d="M114.26 143.16v-14a9.22 9.22 0 10-18.43 0v14c-15.27 2.84-24.74 15.08-24.74 27.33H139c0-12.24-9.5-24.49-24.74-27.33z" fill="#CEAFA0" />
              ...
              <path className="shoulder" d="M95.82 142.87c-16 1.84-29.37 19.5-29.37 40h29.37z" fill="#111827" />
              <path className="shoulder" d="M114.23 142.67c15.76 1.85 29 19.6 29 40.2h-29z" fill="#111827" />
            </g>
            <path className="shadow" d="M95.82 122.36h18.41v14.31s-10.5 5.54-18.41 0z" fill="#CEAFA0" />
            <g className="head">
              ...
              >
                ...
                <g className="ear-left ear">
                  <path d="M63.52 105.14A8.21 8.21 0 0072 113.2a8.36 8.36 0 008.51-8.1A8.21 8.21 0 0072 97a8.36 8.36 0 00-8.48 8.14z" fill="#C49E8D" />
                  <path d="M68.54 104.48a17 17 0 014.14.41c1.07.31 1.94 1 3 1.31a.39.39 0 00.43-.57c-1.15-2.38-5.49-1.86-7.58-1.67a.26.26 0 000 .52z" fill="black" />
                </g>
                <g className="ear-right ear">
                  <path d="M144.37 105.24a8.2 8.2 0 01-8.37 8.06 8.35 8.35 0 01-8.51-8.1 8.21 8.21 0 018.42-8.06 8.35 8.35 0 018.46 8.1z" fill="#C49E8D" />
                  <path d="M139.6 104c-2.1-.19-6.43-.72-7.59 1.67a.39.39 0 00.44.57c1.07-.26 1.92-1 3-1.31a17.51 17.51 0 014.15-.41.26.26 0 000-.52z" fill="black" />
                </g>

                {/* Face */}
                <rect x="73.99" y="48.26" width="61.54" height="80.49" rx="26.08" transform="rotate(180 104.76 88.5)" fill="#CEAFA0" />
                ...
                <g className="inner-face">
                  ...
                  {/* Mouth */}
                  <path className="mouth" d="M97 107.52s7.06 4.62 14 1.59" fill="none" stroke="black" strokeWidth="1.04" />
                  <path className="oh" opacity="0" d="M105.56,117.06c4-.14,5-2.89,4.7-5.64s-1.88-6.7-4.84-6.62-4.73,4.36-4.9,6.72S101.57,117.19,105.56,117.06Z" fill="black" />
                  ...
                  {/* Nose */}
                  <path className="nose" d="M102.39 98.13s3.09 1.55 5.78 0" fill="none" stroke="black" />

                  {/* Blush */}
                  <path className="blush-left eye" d="M89.9 98.17a2.66 2.66 0 01-1.55-.93 3.73 3.73 0 01-.76-3.12 3 3 0 011-1.56 2 2 0 011.4-.42 3 3 0 012.5 2.72.76.76 0 010 .21 3.19 3.19 0 01.11.91 2.1 2.1 0 01-1.77 2.21 2.07 2.07 0 01-.93-.02zM89.34 96v-.05s-.04.05 0 .05z" fill="#A0654F" fillRule="evenodd" />
                  <path className="blush-right eye" d="M118.93 98.19a2.09 2.09 0 01-1.77-2.19 3.58 3.58 0 01.1-.91v-.21a3 3 0 012.51-2.72 2 2 0 011.4.42 3 3 0 011 1.56 3.73 3.73 0 01-.76 3.12 2.66 2.66 0 01-1.55.93 2.08 2.08 0 01-.93 0zm1.53-2.2v.05c0 .05.05-.04 0-.04z" fill="#A0654F" fillRule="evenodd" />
                </g>
