      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="relative">
            <div className="h-[400px] w-[400px] bg-gradient-to-br rounded-full from-blue-400 to-blue-600 overflow-hidden">
              <img
                src={profileImage}
                alt="Khushbu Vohora"
              ...
              />
              <div className="absolute inset-0 hidden items-center justify-center text-white text-xl font-bold">
                Khushbu Vohora
              </div>
            </div>
          </div>
